    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
        <div className="text-center">
          ...
          <Button variant="primary" onClick={() => router.push('/consult')}>
            Back to Consult
          </Button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-900 flex flex-col">
      ...
      <div className="bg-gray-800 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-white font-semibold">Dr. Sarah Jenkins</h3>
            <p className="text-gray-400 text-sm">Dermatology Specialist</p>
          </div>
        </div>
        <div className="text-white text-sm font-mono">{formatDuration(duration)}</div>
      </div>
      ...
      <div className="flex-1 relative bg-black">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-gray-800">
          <div className="text-center">
            <div className="w-32 h-32 rounded-full bg-teal-600 flex items-center justify-center text-6xl mb-4 mx-auto">
              👨‍⚕️
            </div>
            <p className="text-white text-lg font-semibold">Dr. Sarah Jenkins</p>
      ...
      {/* Info Banner */}
      <div className="bg-teal-600 px-4 py-2 text-center text-white text-sm">
        💡 This is a demo interface. In production, this would use Daily.co or similar video SDK.
      </div>
    </div>
  );
}
